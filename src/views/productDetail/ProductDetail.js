...
export default class ProductDetail extends Component {
 ...
 setModalHide=(Hide)=>{
    ...
    render() {
        ...
        const {URL,imgArray,from,data,loading, dataLoaded} = this.state;
        // console.log('id zaheer ahmna',this.param.Id)
        // console.log('image URL',URL)
        // console.log('Image Array',this.state.imgArray[1])
        //console.log('images',this.state.imgArray)
        //console.log('collections',this.state.data)
