...
export default class PaidAmount extends Component {
    constructor(props) {
        super(props);
        this.state = {
            payment: '',errorMsg:'',
    ...
    saveInfo = () => { 
        ...
        if(ValidateDecimalNumber(payment)){
    ...
    render() {
        const { date, payment, isDatePickerVisible,errorMsg } = this.state;
        return (
                ...
                <Container style={{ flex: 1 }}>
                    ...
                    <TouchableWithoutFeedback onPress={() => this.keyboardDismiss()}>
                        ...
                        <View style={styles.content}>
                            <Text_Input
                                placeholder={'Amount'}
                                onChangeText={(value) => this.setState({ payment: value, errorMsg:'' })}
